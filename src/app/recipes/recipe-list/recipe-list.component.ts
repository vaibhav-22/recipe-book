...
export class RecipeListComponent implements OnInit {
  ...
  new Recipe('Test Recipe', 'This is test description','https://www.bbcgoodfood.com/sites/default/files/recipe-collections/collection-image/2013/05/spaghetti-puttanesca_1.jpg')];
